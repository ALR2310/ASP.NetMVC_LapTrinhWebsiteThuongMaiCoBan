    ...
    public class ProductCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductCategory != null ? 
                          ...
                          Problem("Entity set 'MyDbContext.ProductCategory'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Title")] ProductCategory productCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Title")] ProductCategory productCategory)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyDbContext.ProductCategory'  is null.");
            }
            var productCategory = await _context.ProductCategory.FindAsync(id);
            if (productCategory != null)
            {
